...
extension AppEnvironment {
    ...
    var usesWebResearch: Bool {
        provider == .ollama && (selectedConversation?.usesWebResearch ?? false)
    }
    ...
    var webResearchDisclosure: String {
        guard provider == .ollama else { return "SearXNG web research is available only with local Ollama models." }
